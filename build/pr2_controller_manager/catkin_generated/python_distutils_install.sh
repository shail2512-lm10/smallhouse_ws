...
echo_and_run cd "/home/shail/smallhouse_ws/src/pr2_controller_manager"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/shail/smallhouse_ws/src/pr2_controller_manager/setup.py" \
     \
    build --build-base "/home/shail/smallhouse_ws/build/pr2_controller_manager" \
    install \
    --root="${DESTDIR-/}" \
