...
#if defined(_WIN32) && defined(MAX_BAT_COUNT)
  #undef MAX_BAT_COUNT
#endif
#if defined(_WIN32) && defined(MAX_BAT_REG)
  #undef MAX_BAT_REG
#endif
...
bool operator==(const ::pr2_msgs::BatteryServer_<ContainerAllocator1> & lhs, const ::pr2_msgs::BatteryServer_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.id == rhs.id &&
    lhs.lastTimeSystem == rhs.lastTimeSystem &&
    lhs.timeLeft == rhs.timeLeft &&
    lhs.averageCharge == rhs.averageCharge &&
    lhs.message == rhs.message &&
    lhs.lastTimeController == rhs.lastTimeController &&
    lhs.present == rhs.present &&
    lhs.charging == rhs.charging &&
    lhs.discharging == rhs.discharging &&
    lhs.reserved == rhs.reserved &&
    lhs.powerPresent == rhs.powerPresent &&
    lhs.powerNG == rhs.powerNG &&
