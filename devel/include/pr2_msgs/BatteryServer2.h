...
bool operator==(const ::pr2_msgs::BatteryServer2_<ContainerAllocator1> & lhs, const ::pr2_msgs::BatteryServer2_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.id == rhs.id &&
    lhs.last_system_update == rhs.last_system_update &&
    lhs.time_left == rhs.time_left &&
    lhs.average_charge == rhs.average_charge &&
    lhs.message == rhs.message &&
    lhs.last_controller_update == rhs.last_controller_update &&
