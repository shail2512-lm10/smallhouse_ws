...
bool operator==(const ::pr2_msgs::BatteryState_<ContainerAllocator1> & lhs, const ::pr2_msgs::BatteryState_<ContainerAllocator2> & rhs)
{
  return lhs.lastTimeBattery == rhs.lastTimeBattery &&
    lhs.batReg == rhs.batReg &&
    lhs.batRegFlag == rhs.batRegFlag &&
    lhs.batRegTime == rhs.batRegTime;
}
