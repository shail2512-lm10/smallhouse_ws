...
bool operator==(const ::pr2_msgs::BatteryState2_<ContainerAllocator1> & lhs, const ::pr2_msgs::BatteryState2_<ContainerAllocator2> & rhs)
{
  return lhs.present == rhs.present &&
    lhs.charging == rhs.charging &&
    lhs.discharging == rhs.discharging &&
    lhs.power_present == rhs.power_present &&
    lhs.power_no_good == rhs.power_no_good &&
    lhs.inhibited == rhs.inhibited &&
    lhs.last_battery_update == rhs.last_battery_update &&
    lhs.battery_register == rhs.battery_register &&
    lhs.battery_update_flag == rhs.battery_update_flag &&
    lhs.battery_register_update == rhs.battery_register_update;
}
