...
bool operator==(const ::pr2_msgs::DashboardState_<ContainerAllocator1> & lhs, const ::pr2_msgs::DashboardState_<ContainerAllocator2> & rhs)
{
  return lhs.motors_halted == rhs.motors_halted &&
    lhs.motors_halted_valid == rhs.motors_halted_valid &&
    lhs.power_board_state == rhs.power_board_state &&
    lhs.power_board_state_valid == rhs.power_board_state_valid &&
    lhs.power_state == rhs.power_state &&
    lhs.power_state_valid == rhs.power_state_valid &&
    lhs.access_point == rhs.access_point &&
    lhs.access_point_valid == rhs.access_point_valid;
}
