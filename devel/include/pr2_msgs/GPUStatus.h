...
bool operator==(const ::pr2_msgs::GPUStatus_<ContainerAllocator1> & lhs, const ::pr2_msgs::GPUStatus_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.product_name == rhs.product_name &&
    lhs.pci_device_id == rhs.pci_device_id &&
    lhs.pci_location == rhs.pci_location &&
    lhs.display == rhs.display &&
    lhs.driver_version == rhs.driver_version &&
    lhs.temperature == rhs.temperature &&
    lhs.fan_speed == rhs.fan_speed &&
    lhs.gpu_usage == rhs.gpu_usage &&
