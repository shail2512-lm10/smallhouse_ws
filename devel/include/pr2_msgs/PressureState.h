...
bool operator==(const ::pr2_msgs::PressureState_<ContainerAllocator1> & lhs, const ::pr2_msgs::PressureState_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.l_finger_tip == rhs.l_finger_tip &&
    lhs.r_finger_tip == rhs.r_finger_tip;
}
