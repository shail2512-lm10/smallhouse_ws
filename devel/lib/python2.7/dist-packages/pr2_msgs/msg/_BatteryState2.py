...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if len(self.battery_register_update) != 48:
        self._check_types(ValueError("Expecting %s items but found %s when writing '%s'" % (48, len(self.battery_register_update), 'self.battery_register_update')))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.battery_update_flag = list(map(bool, self.battery_update_flag))
