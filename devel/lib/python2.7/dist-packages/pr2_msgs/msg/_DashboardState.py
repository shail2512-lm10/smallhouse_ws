...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.power_board_state.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.power_board_state.name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.power_state.prediction_method = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.access_point.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.access_point.essid = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.access_point.macaddr = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.access_point.rate = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.access_point.tx_power = str[start:end].decode('utf-8', 'rosmsg')
      else:
