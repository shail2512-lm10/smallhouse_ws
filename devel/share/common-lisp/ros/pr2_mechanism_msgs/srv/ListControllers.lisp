...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ListControllers-request>)))
  ...
  (cl:format cl:nil "# The ListControllers service returns a list of controller names that are spawned~%# inside pr2_mechanism_control, and their corresponding stats. The state is either~%# running or stopped.~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ListControllers-request)))
  "Returns full string definition for message of type 'ListControllers-request"
  (cl:format cl:nil "# The ListControllers service returns a list of controller names that are spawned~%# inside pr2_mechanism_control, and their corresponding stats. The state is either~%# running or stopped.~%~%~%~%"))
