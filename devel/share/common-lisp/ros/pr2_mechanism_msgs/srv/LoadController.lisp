...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LoadController-request>)))
  ...
  (cl:format cl:nil "# The LoadController service allows you to load a single controller ~%# inside pr2_controller_manager~%~%# To load a controller, specify the \"name\" of the controller. ~%# The return value \"ok\" indicates if the controller was successfully~%# constructed and initialized or not.~%~%string name~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LoadController-request)))
  "Returns full string definition for message of type 'LoadController-request"
  (cl:format cl:nil "# The LoadController service allows you to load a single controller ~%# inside pr2_controller_manager~%~%# To load a controller, specify the \"name\" of the controller. ~%# The return value \"ok\" indicates if the controller was successfully~%# constructed and initialized or not.~%~%string name~%~%~%"))
